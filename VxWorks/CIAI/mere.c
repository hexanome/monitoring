...
void initialisation()
{
	...
	mid_log		 = msgQCreate(10,4,0); 
	mid_packing  = msgQCreate(10,4,0); 
	mid_patch 	 = msgQCreate(10,4,0); 
	mid_boxing   = msgQCreate(10,4,0); 
...
//							  );
	...
	tid_warehouse  = taskSpawn("warehouse",  
							  30,                              
							  0x0008,                          
							  10000,                           
							  (FUNCPTR) capteur,		             
